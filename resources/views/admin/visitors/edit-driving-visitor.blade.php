...
@section('title', 'Edit Driving Visitor')
@section('content')
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('updatedrivingvisitor', $driver->slug)}}" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <div class="row mb-3">
                                <label for="inputText" class="col-sm-2 col-form-label">Driver Full Name</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="full_name" value="{{ $driver->name }}">
                                    @error('full_name')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number"  class="form-control" name="phone_number" value="{{ $driver->phone_number}}">
                                    @error('phone_number')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number"  class="form-control" name="id_number" value="{{$driver->id_number}}">
                                    @error('id_number')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number"  class="form-control" name="license_number" value="{{ $driver->license_number}}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number"  class="form-control" name="plate_number" value="{{ $driver->plate_number}}">
                                    @error('plate_number')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <small class="text-success">selected - {{ $driver->category }}</small>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" min="1" class="form-control" name="total_numbers" value="{{ $driver->total_members}}">
                                    @error('total_numbers')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" style="height: 100px" name="visiting_reason">{{ $driver->visiting_reason }}</textarea>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-warning">Update Driving Visitor</button>
                                </div>
                            </div>
